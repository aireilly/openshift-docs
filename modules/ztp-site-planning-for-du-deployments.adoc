...
* Develop a network model. The network model depends on various factors such as the size of the area of coverage, number of hosts, projected traffic load, network slicing, DNS, and DHCP requirements.
...
* Submit purchase orders for host hardware and supporting equipment.
