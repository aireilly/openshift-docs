...
The Loki Operator supports link:https://aws.amazon.com/[AWS S3], link:https://azure.microsoft.com[Azure], link:https://cloud.google.com/[GCS], link:https://min.io/[Minio],  link:https://www.redhat.com/en/technologies/cloud-computing/openshift-data-foundation[OpenShift Data Foundation], link:https://us.alibabacloud.com/[Alibaba Cloud] and link:https://docs.openstack.org/swift/latest/[Swift] for LokiStack object storage.
