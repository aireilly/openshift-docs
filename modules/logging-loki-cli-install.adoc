...
...
openshift-logging                                       clusterlogging.5.5.0-202007012112.p0         OpenShift Logging          5.1.0-202007012112.p0              Succeeded
...
----
...
cluster-logging-operator-cd7849df4-jt2rw   1/1     Running   0          4h11m
collector-6x66c                            2/2     Running   0          2m14s
collector-fpm79                            2/2     Running   0          2m13s
collector-g9ck7                            2/2     Running   0          2m14s
collector-j2td4                            2/2     Running   0          2m13s
collector-nzp8h                            2/2     Running   0          2m12s
collector-t6f8c                            2/2     Running   0          2m13s
logging-view-plugin-547986d85c-hxff2       1/1     Running   0          2m26s
----

. Install the `Loki Operator` by creating the following objects:

.. Create an Operator Group object YAML file (for example, `loki-og.yaml`) for the Red Hat OpenShift Logging Operator:
+
[source,terminal]
----
$ oc create -f <file-name>.yaml
