...
For more information see, xref:../networking/ptp/configuring-ptp#configuring-linuxptp-services-as-grandmaster-clock-dual-nic_configuring-ptp[Configuring linuxptp services as a grandmaster clock for dual E810 Westport Channel NICs]. (link:https://issues.redhat.com/browse/TELCODOCS-1480[*TELCODOCS-1480*])
...
==== Updating
To update an existing {product-title} 4.14 cluster to this latest release, see xref:../updating/updating-cluster-cli.adoc#updating-cluster-cli[Updating a cluster using the CLI].
